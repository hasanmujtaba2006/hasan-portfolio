...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden font-sans scroll-smooth md:cursor-none">
      ...
      {/* Navigation Bar */}
      <nav aria-label="Main Navigation" className="fixed top-0 w-full p-6 flex justify-between items-center z-50 backdrop-blur-md bg-[#0a0a0a]/70 border-b border-white/5">
        <a href="#" aria-label="Hasan Mujtaba Home" className="text-2xl font-bold tracking-tighter text-emerald-400 md:cursor-none">HM.</a>
      ...
      <main className="relative h-screen flex items-center justify-center px-6 md:px-24 pt-20">
        ...
        <div className="relative z-10 w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center pointer-events-none">
          ...
          >
            <p className="text-emerald-400 font-medium tracking-wide mb-3">
              Assalam-u-alaikum, my name is
            </p>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-4 drop-shadow-lg">
              Hasan Mujtaba.
            </h1>
            <h2 className="text-4xl md:text-6xl font-bold text-gray-500 tracking-tight mb-6 drop-shadow-lg">
      ...
      {/* About Section */}
      <section id="about" aria-label="About Hasan Mujtaba" className="relative z-10 min-h-screen bg-[#0a0a0a] px-6 md:px-24 py-24 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="bg-[#111111] rounded-xl aspect-square relative z-10 overflow-hidden">
                 ...
                 <img 
                   src="/profile.jpg" 
                   alt="Hasan Mujtaba - Software Developer and IoT Engineer" 
                   loading="lazy"
                   decoding="async"
      ...
      {/* Projects Section */}
      <section id="projects" aria-label="Featured Projects" className="relative z-10 min-h-screen bg-[#0a0a0a] px-6 md:px-24 py-24">
              ...
              >
                ...
                <div className="w-full h-56 bg-gray-900 relative overflow-hidden border-b border-white/5">
                  ...
                  {project.video ? (
                    <video 
                      ...
                      playsInline
                      preload="metadata"
                      aria-label={`${project.title} video demonstration`}
                ...
                <div className="p-8 flex flex-col flex-grow justify-between">
                  ...
                  <div className="mt-8 flex gap-6">
                    {project.github !== "#" && (
                      <a href={project.github} target="_blank" rel="noopener noreferrer" aria-label={`View ${project.title} source code on GitHub`} className="text-sm text-gray-300 hover:text-emerald-400 flex items-center gap-2 transition-colors md:cursor-none z-20 pointer-events-auto">
                    ...
                    {project.demo !== "#" && (
                      <a href={project.demo} target="_blank" rel="noopener noreferrer" aria-label={`View live demo of ${project.title}`} className="text-sm text-gray-300 hover:text-emerald-400 flex items-center gap-2 transition-colors md:cursor-none z-20 pointer-events-auto">
      ...
      {/* Contact Section */}
      <section id="contact" aria-label="Contact Hasan Mujtaba" className="relative z-10 bg-[#0a0a0a] px-6 md:px-24 py-32 flex flex-col items-center text-center">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        ...
        >
          ...
          <a href="mailto:hasanmujtaba.q@gmail.com" aria-label="Send email to Hasan Mujtaba" className="px-8 py-4 bg-emerald-400 text-[#0a0a0a] font-bold rounded-md hover:bg-emerald-300 transition-colors duration-300 inline-block md:cursor-none z-20 pointer-events-auto">
            Say Hello
          </a>
        </motion.div>
      </section>
      ...
      <footer className="relative z-10 py-6 text-center text-gray-500 text-sm font-mono bg-[#0a0a0a]">
        <div className="flex justify-center space-x-6 mb-4">
          <a href="https://github.com/hasanmujtaba2006" target="_blank" rel="noopener noreferrer" aria-label="Hasan Mujtaba on GitHub" className="hover:text-emerald-400 transition-colors md:cursor-none pointer-events-auto">GitHub</a>
          <a href="https://www.linkedin.com/in/hasan-mujtaba-55b87037b/" target="_blank" rel="noopener noreferrer" aria-label="Hasan Mujtaba on LinkedIn" className="hover:text-emerald-400 transition-colors md:cursor-none pointer-events-auto">LinkedIn</a>
          <a href="https://t.me/Hasanmujtaba12" target="_blank" rel="noopener noreferrer" aria-label="Hasan Mujtaba on Telegram" className="hover:text-emerald-400 transition-colors md:cursor-none pointer-events-auto">Telegram</a>
          <a href="https://discordapp.com/users/hasan_0249" target="_blank" rel="noopener noreferrer" aria-label="Hasan Mujtaba on Discord" className="hover:text-emerald-400 transition-colors md:cursor-none pointer-events-auto">Discord</a>
        </div>
